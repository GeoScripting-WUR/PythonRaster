...
The municipality of Wageningen wants to know the maximum height and total volume of each building on the campus. Work with a project structure and create well-structured scripts with one main script. Create several functions to derive the building volume of buildings on the campus:
...
2. Calculate the volumes (m3) per building. Present the result nicely summarized in one table.
